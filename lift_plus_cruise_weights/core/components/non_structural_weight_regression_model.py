...
class NonStructuralWeightRegressionModel(Model):
    ...
    def define(self):
        ...
        non_structural_weight =   5.49683441 * wing_area + 91.34214517 * wing_AR +  1.9698989 * fuselage_length + 1.00166832 * battery_weight + 3.72346506 * cruise_speed + 2032.858763286621

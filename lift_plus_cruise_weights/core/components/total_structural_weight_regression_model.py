...
class TotalStructuralWeightRegressionModel(Model):
    ...
    def define(self):
        ...
        total_structural_weight =   3.44445789e+00 * wing_area + 6.98584506e+01 * wing_AR + 3.98349615e+01 * fuselage_length + 6.80710943e-02 * battery_weight + 1.42482522e+00 * cruise_speed  -1384.6035424747126
